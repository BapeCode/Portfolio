...
export default function DesktopSkills({title, data}: SkillProps) {
    return (
        <div className="flex justify-start items-center flex-col gap-3 h-full w-full">
            ...
            <Separator className="w-full"/>
                ...
                <Carousel className="w-1/2 sm:w-2/3 lg:w-full max-w-xs h-full flex items-center justify-center">
                    ...
                    <CarouselPrevious className='bg-white cursor-pointer hidden sm:flex' />
                    <CarouselNext className='bg-white cursor-pointer hidden sm:flex'/>
                </Carousel>
            </div>
    )
}
